...
export const getServerSideProps = async () => {
  const endpoint = process.env.BACKEND_URL + "content/innovation-hub";
...
const InnovationHub = ({
  ...
  return (
    <>
      <NextSeo title="Innovation Hub - Olashore International School" />
      ...
      <div>
        ...
        <Breadcrumbs
          links={[
            ...
            { title: "Innovation Hub", route: null },
          ]}
        />
        ...
        <section className="   container mx-auto p-4 xl:px-16 mb-4 lg:mb-8">
          <div
            ...
            dangerouslySetInnerHTML={{ __html: data.sections[3].text }}
          />
        </section>
      </div>
    </>
