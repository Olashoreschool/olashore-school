...
export const getServerSideProps = async () => {
  const endpoint = process.env.BACKEND_URL + "content/work-experience";
...
const WorkExperience = ({
  ...
  return (
    <>
      <NextSeo title="Work Experience - Olashore International School" />
          ...
          links={[
            {
              ...
              route: "/enrichment-opportunities/leadership/work-experience",
            },
            { title: "Work Experience", route: null },
          ]}
        />
