...
export const getServerSideProps = async () => {
  const endpoint = process.env.BACKEND_URL + "content/leadership";
...
const Leadership = ({
  ...
  return (
    <>
      <NextSeo title="Leadership - Olashore International School" />
      ...
      <div>
        ...
        <Breadcrumbs
          links={[
            ...
            { title: "Student Leadership", route: null },
          ]}
        />
        ...
        <section className="   container mx-auto p-4 xl:px-16 mb-4 lg:mb-8">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <aside>
              <Image
                src={data.sections[3].image_left}
                alt={data.heading}
                width={600}
                height={600}
                className="rounded-lg"
        ...
        <section className="   container mx-auto p-4 xl:px-16 mb-4 lg:mb-8">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <aside
              dangerouslySetInnerHTML={{
                __html: data.sections[4].text_left,
              }}
            />

            <aside>
              <Image
                src={data.sections[4].image_right}
                alt={data.heading}
                width={600}
                height={600}
                className="rounded-lg"
